...
def main() -> None:
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Generate Windows version_info.txt for Serena PyInstaller build")
    parser.add_argument(
        "--output",
        type=Path,
    ...
    parser.add_argument(
        "--pyproject", type=Path, default=Path("../../pyproject.toml"), help="Path to pyproject.toml (default: ../../pyproject.toml)"
    )
    parser.add_argument(
        "--template",
        type=Path,
