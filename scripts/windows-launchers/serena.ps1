#!/usr/bin/env pwsh
# ==============================================================================
# Serena CLI Launcher - PowerShell Script
# ==============================================================================
#
# This script launches the Serena CLI executable in portable mode.
#
# Features:
...
elseif (Test-Path "$ScriptDir\..\serena.exe") {
    ...
    Write-Host "ERROR: Cannot locate serena.exe" -ForegroundColor Red
...
if (-not (Test-Path $SerenaExe)) {
    Write-Host "ERROR: serena.exe not found at:" -ForegroundColor Red
    Write-Host "  $SerenaExe"
    Write-Host ""
...
try {
    ...
    Write-Host "ERROR: Failed to launch serena.exe" -ForegroundColor Red
