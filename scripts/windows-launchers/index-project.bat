@echo off
REM ==============================================================================
REM Serena Index Project Tool Launcher - Windows Batch Script
REM ==============================================================================
REM
REM This script launches the Serena project indexing tool in portable mode.
REM
REM Features:
...
REM
REM Usage:
REM   index-project.bat [PROJECT_PATH]
REM   index-project.bat C:\MyProjects\MyApp
REM   index-project.bat --help
REM
REM Note: This tool is deprecated. Use 'serena project index' instead.
REM
REM ==============================================================================
...
if exist "%SCRIPT_DIR%\index-project.exe" (
    set "SERENA_PORTABLE_ROOT=%SCRIPT_DIR%"
) else if exist "%SCRIPT_DIR%\..\index-project.exe" (
    set "SERENA_PORTABLE_ROOT=%SCRIPT_DIR%\.."
) else (
    echo ERROR: Cannot locate index-project.exe
    echo Searched in:
    echo   - %SCRIPT_DIR%
    echo   - %SCRIPT_DIR%\..
    echo.
...
if not exist "%INDEX_PROJECT_EXE%" (
    echo ERROR: index-project.exe not found at:
    echo   %INDEX_PROJECT_EXE%
    echo.
