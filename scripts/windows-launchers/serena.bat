@echo off
REM ==============================================================================
REM Serena CLI Launcher - Windows Batch Script
REM ==============================================================================
REM
REM This script launches the Serena CLI executable in portable mode.
REM
REM Features:
...
REM
REM Usage:
REM   serena.bat [ARGUMENTS...]
REM   serena.bat --help
REM   serena.bat project list
REM   serena.bat tools list
REM
REM ==============================================================================
...
if exist "%SCRIPT_DIR%\serena.exe" (
    ...
    echo ERROR: Cannot locate serena.exe
    echo Searched in:
    echo   - %SCRIPT_DIR%
    echo   - %SCRIPT_DIR%\..
    echo.
...
if not exist "%SERENA_EXE%" (
    echo ERROR: serena.exe not found at:
    echo   %SERENA_EXE%
    echo.
